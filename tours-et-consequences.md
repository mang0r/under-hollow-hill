...
Quand tu veux élargir la conversation, changer sa direction ou son sujet, ou en prendre le contrôle un instant, tu le fais en tentant un tour.
...
Quand tu fais un pas vers l'hiver, efface une marque dans la colonne été et coche la même ligne dans la colonne hiver.

Chaque fois que tu fais un pas vers l'été ou vers l'hiver, retire 1 au modificateur d'un de tes tours et ajoute 1 au modificateur d'un autre tour. Choisis intentionnellement, en accord avec ce que tu ressens face au changement. Reste dans un minimum de −2 et un maximum de +3.
...
Quand quelqu'un te rend un service, tu lui es redevable. Prends garde, prends garde : c'est ton créancier qui pèse la valeur de son service contre la valeur de ton remboursement, et s'endetter envers quelqu'un est toujours dangereux.

Pour les fées :
Quand tu es redevable à quelqu'un, la loi de Féerie et ta nature féerique exigent que tu t'acquittes et que tu rendes la balance. Si tu rechignes ou tardes à rembourser ta dette, ton créancier peut le considérer comme une insulte, ou pire.

Pour les êtres humains :
Quand tu es redevable à quelqu'un, la loi de Féerie exige que tu t'acquittes et que tu rendes la balance. L'honneur humain peut aussi t'y pousser, mais c'est un maître bien plus laxiste que la nature féerique. Quoi qu'il en soit, si tu rechignes ou tardes à rembourser ta dette, ton créancier peut le considérer comme une insulte, ou pire.

## La violence

La violence en Féerie est considérée comme viscérale, irrévocable et terrifiante.

Pour les fées :
Quand tu es blessé, choqué, outragé ou consterné, tu dois immédiatement choisir 1 :
- Tu meurs.
- Tu te retires sur-le-champ dans une fureur froide et digne.
- Tu te tords, gémis et maudis dans un étalage d'agonie mélodramatique.
- D'un pas, tu vas immédiatement et pleinement vers l'hiver.
- Tu te considères cruellement maltraité et mutilé, et tu couveras longtemps tes blessures et ta rancune.

La mort féerique :
« Mourir » est une métaphore, même quand quelqu'un le fait vraiment. Les fées peuvent revenir de la mort plus ou moins aisément. Si tu meurs, voici la marche à suivre :

- Quand le cirque se produit à nouveau, rappelle à quelqu'un de reconnaître ou de célébrer un changement dans l'effectif du cirque. Cela permet au cirque de t'inviter à revenir, ou de te dire adieu.
- Si quelqu'un te dit adieu, tu peux choisir de rester mort. Dans ce cas, tu as trois options :
  - Quitter le jeu.
  - Créer un nouveau personnage, soit un PNJ existant, soit un nouveau venu au cirque.
  - Avec l'accord de tous, reprendre le rôle de Maîtresse de Cérémonie, et laisser la MC rejoindre le jeu en tant que joueur.
- Si quelqu'un t'invite à revenir, tu peux choisir de revenir d'entre les morts. Tu peux en profiter pour modifier ton imagerie d'été et d'hiver et les modificateurs de tes tours, si tu le souhaites.
...
- Sur un 4, 5 ou 6, tu es blessé et tu dois soigner ta blessure jusqu'à sa guérison.
...
Quand une fée donne son cœur, c'est pour toujours, jusqu'à ce que ce soit fini. Quand c'est fini, c'est fini pour toujours, jusqu'à ce que ça ne le soit plus. L'amour féerique est rapide comme une ombre, bref comme un rêve, fugace comme l'éclair. Il est dévoué et inconstant, jaloux et pardonnant, lourd dans sa légèreté et sérieux dans sa vanité. Son cours, comme chacun sait, n'a jamais été lisse.

La loi de Féerie considère le cœur comme le moins fiable des organes. Les promesses faites par le cœur sont les moins contraignantes des promesses ; les services rendus par le cœur ressemblent le plus à des dons ; les dons faits par le cœur ressemblent le plus à des prêts.
